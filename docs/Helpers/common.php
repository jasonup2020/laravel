...
if (!function_exists('message')) {
     ...
     * @return array 返回统一的 API 响应数组
     */
    function message($msg = "操作成功", $success = true, $data = null, $code = 200, $extra = null) {
        // 处理多语言转换
        if ($msg == "操作成功" || $msg == "ok") {
 ...
 * 生成成功的 API 响应
 * 
 * @param string $message 响应消息，支持多语言
 * @param mixed $data 响应数据
 * @param int $code HTTP 状态码，默认为 200
 * @return array 返回统一的 API 响应数组
 */
if (!function_exists('success')) {
    function success($message = 'Success', $data = null, $code = 200)
    {
        return message($message, true, $data, $code);
    }
}
 ...
 * 生成失败的 API 响应
 * 
 * @param string $message 错误消息，支持多语言
 * @param int $code HTTP 状态码，默认为 400
 * @param mixed $errors 错误信息
 * @return array 返回统一的 API 响应数组
 */
if (!function_exists('error')) {
    function error($message = 'Error', $code = 400, $errors = null)
    {
        return message($message, false, null, $code, $errors);
    }
}
